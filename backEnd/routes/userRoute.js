...
const { registerUser, loginUser, logoutUser, updateUser, getAllUsers, imageUpload, getUser, deleteImage, deleteUser, test, getLogs, forgotPassword, resetPassword, getAnyUser } = require("../controllers/userController")
...
router.route("/user/:id").patch(isAuthenticated, updateUser).delete(deleteUser).get(isAuthenticated,getAnyUser)
